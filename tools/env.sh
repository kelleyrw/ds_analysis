...
export PYTHONPATH=/usr/local/lib/python2.7/site-packages/gurobipy:$MR/gurobi_study/python:$DSA/bin/release:$RS/utilities:$HOME/Development/rovi/Research/projects/python
